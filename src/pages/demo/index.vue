<template>
  <view class="content">
    ...
    <view class="space-y-[20rpx] flex flex-col items-center">
      ...
      <view
        class="h-60 w-40 grid grid-cols-3 divide-x-[10px] divide-[#010101] divide-solid">
...
const classArray = computed(() => [
  title.value ? 'bg-[#ff00ff]' : undefined,
  {
    ...
    "bg-[url('https://img95.699pic.com/xsj/1l/k9/hn.jpg!/fh/300')]": true
  }
])
...
.test {
  ...
  @apply flex items-center justify-center h-[100px] w-[100px] rounded-[40px] bg-[#123456] bg-opacity-[0.54] text-[#ffffff];
}
</style>
